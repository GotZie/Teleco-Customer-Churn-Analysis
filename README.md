...
This project develops and evaluates multiple machine learning models to predict customer churn for a fictional telecommunications company. The project builds a binary classification pipeline to answer the vital business question:   
Which factors drive customer attrition, and how can we predict who will leave before they do?

The objective is to identify customers at risk of leaving and provide actionable insights that support targeted retention strategies.
